...
<section class="hero-wrap style1 bg-spring">
            <img src="{{asset('front_template/assets/img/hero/hero-shape-1.png')}}" alt="Image" class="hero-shape-one">
            <img src="{{asset('front_template/assets/img/hero/hero-shape-2.png')}}" alt="Image" class="hero-shape-two">
            <img src="{{asset('front_template/assets/img/hero/hero-shape-3.png')}}" alt="Image" class="hero-shape-three">
            <img src="{{asset('front_template/assets/img/hero/hero-shape-4.png')}}" alt="Image" class="hero-shape-four md-none">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                           <div class="hero-img-wrap">
                              <img src="{{asset('front_template/assets/img/hero/hero-slide-4.png')}}" alt="Image">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="hero-slide-item">
                  <div class="container-fluid">
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                           <div class="hero-img-wrap">
                              <img src="{{asset('front_template/assets/img/hero/hero-slide-5.png')}}" alt="Image">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="hero-slide-item">
                  <div class="container-fluid">
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                           <div class="hero-img-wrap">
                              <img src="{{asset('front_template/assets/img/hero/hero-slide-6.png')}}" alt="Image">
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row gx-5 align-items-center">
                  <div class="col-lg-6">
                     <div class="about-img-wrap">
                        <img src="{{asset('front_template/assets/img/about/about-shape-1.png')}}" alt="Image" class="about-shape-one bounce">
                        <img src="{{asset('front_template/assets/img/about/about-shape-2.png')}}" alt="Image" class="about-shape-two moveHorizontal">
                        <img src="{{asset('front_template/assets/img/about/about-img-1.png')}}" alt="Image" class="about-img">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="about-content">
                        <img src="{{asset('front_template/assets/img/about/about-shape-3.png')}}" alt="Image" class="about-shape-three">
               ...
               <div class="row justify-content-center">
                     ...
                     <div class="feature-card style1">
                        <div class="feature-info">
                           <div class="feature-title">
                              <span><img src="{{asset('front_template/assets/img/feature/feature-icon-4.png')}}" alt="Image"></span>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-info">
                           <div class="feature-title">
                              <span><img src="{{asset('front_template/assets/img/feature/feature-icon-5.png')}}" alt="Image"></span>
                              <h3>Send Money</h3>
                           </div>
                           <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
                        </div>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="feature-card style1">
                        <div class="feature-info">
                           <div class="feature-title">
                              <span><img src="{{asset('front_template/assets/img/feature/feature-icon-6.png')}}" alt="Image"></span>
               ...
               <div class="row gx-5 align-items-center">
                        ...
                        <div class="feature-item-wrap">
                           <div class="feature-item">
                              <div class="feature-icon">
                                 <img src="{{asset('front_template/assets/img/security/security-icon-1.png')}}" alt="Image">
                              </div>
                           ...
                           <div class="feature-item">
                              <div class="feature-icon">
                                 <img src="{{asset('front_template/assets/img/security/security-icon-2.png')}}" alt="Image">
                              </div>
                              <div class="feature-text">
                  ...
                  <div class="col-lg-6 col-12 order-lg-2 order-1">
                     <div class="security-img-wrap">
                        <img src="{{asset('front_template/assets/img/security/security-shape-1.png')}}" alt="Image" class="security-shape-one">
                        <img src="{{asset('front_template/assets/img/security/security-shape-2.png')}}" alt="Image" class="security-shape-two">
                        <img src="{{asset('front_template/assets/img/security/security-1.png')}}" alt="Image">
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="row">
                        <div class="col-md-6 mmt-45">
                           <div class="service-card style1">
                              ...
                              <img src="{{asset('front_template/assets/img/service/service-icon-1.png')}}" alt="Image">
                              </span>
                           ...
                           <div class="service-card style1">
                              <span class="service-icon">
                              <img src="{{asset('front_template/assets/img/service/service-icon-2.png')}}" alt="Image">
                              </span>
                        ...
                        <div class="col-md-6">
                           <div class="service-card style1">
                              <span class="service-icon">
                              <img src="{{asset('front_template/assets/img/service/service-icon-3.png')}}" alt="Image">
                              </span>
                              <h3><a href="service-details.html">Simple Dashboard</a></h3>
                              <p>Lorem ipsum dolor sit ametus situlo consec tetur adicingus elittque coris sapite ill  o sit.</p>
                           </div>
                           <div class="service-card style1">
                              <span class="service-icon">
                              <img src="{{asset('front_template/assets/img/service/service-icon-4.png')}}" alt="Image">
                              </span>
               ...
               <div class="row align-items-center gx-5">
                  <div class="col-lg-6">
                     <div class="app-img-wrap">
                        <img class="bounce" src="{{asset('front_template/assets/img/app/app-1.png')}}" alt="Image">
                        <img class="app-shape-one" src="{{asset('front_template/assets/img/app/app-shape-1.png')}}" alt="Image">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="app-content">
                        ...
                        <div class="app-btn">
                           <a href="https://www.apple.com/app-store/"><img src="{{asset('front_template/assets/img/apple-store.png')}}" alt="Image"></a>
                           <a href="https://play.google.com/store/apps"><img src="{{asset('front_template/assets/img/play-store.png')}}" alt=""></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="testimonial-slider-one owl-carousel">
                     ...
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-1.jpg')}}" alt="Image">
                           </div>
                        </div>
                  ...
                  <div class="testimonial-card style1">
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-2.jpg')}}" alt="Image">
                           </div>
                        </div>
                        <div class="quote-icon">
                           <i class="flaticon-quote"></i>
                  ...
                  <div class="testimonial-card style1">
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-3.jpg')}}" alt="Image">
                           </div>
                        </div>
                        <div class="quote-icon">
                           <i class="flaticon-quote"></i>
                  ...
                  <div class="testimonial-card style1">
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-4.jpg')}}" alt="Image">
                           </div>
                        </div>
                        <div class="quote-icon">
                           <i class="flaticon-quote"></i>
                  ...
                  <div class="testimonial-card style1">
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-5.jpg')}}" alt="Image">
                           </div>
                        </div>
                        <div class="quote-icon">
                           <i class="flaticon-quote"></i>
                  ...
                  <div class="testimonial-card style1">
                     <div class="client-info-area">
                        <div class="client-info-wrap">
                           <div class="client-img">
                              <img src="{{asset('front_template/assets/img/testimonials/client-6.jpg')}}" alt="Image">
                           </div>
                        </div>
                        <div class="quote-icon">
                           <i class="flaticon-quote"></i>
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="pricing-table style1">
                        <div class="pricing-header">
                           <h2><img src="{{asset('front_template/assets/img/pricing-star.png')}}" alt="Image">Basic</h2>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="pricing-table style2">
                        <div class="pricing-header">
                           <h2><img src="{{asset('front_template/assets/img/pricing-star.png')}}" alt="Image">Standard</h2>
                           <div class="pricing-header-tag">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                     <div class="pricing-table style1">
                        <div class="pricing-header">
                           <h2><img src="{{asset('front_template/assets/img/pricing-star.png')}}" alt="Image">Premium</h2>
                           <div class="pricing-header-tag">
         ...
         <section class="cta-wrap style1 ptb-100 ">
            <div class="container">
               <img src="{{asset('front_template/assets/img/cta-shape-1.png')}}" alt="Image" class="cta-shape-one xs-none">
               <img src="{{asset('front_template/assets/img/cta-shape-2.png')}}" alt="Image" class="cta-shape-two xs-none">
               <div class="row">
                  <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
