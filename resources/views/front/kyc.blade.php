                            ...
                            <section class="account-wrap ptb-100">
                                <div class="container">
                                    <div class="section-title style1 text-center mb-40">
                                        ...
                                        <h2>Upload file for KYC Verification</h2>
                                    </div>
                                    <form action="{{route('account.kyc')}}" class="account-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="document">Passport or National ID Card # </label>
                                                    <input type="file" id="document" name="document" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <h3>Your Uploaded Document</h3>
                                            </div>
                                        </div>
                                        <div class="row">    
                                            <div class="col-md-12">
